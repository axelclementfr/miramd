...
<div class="setting-group">
  ...
  <div class="setting-row toggle-row"><div><span class="setting-label">{tr('typewriter_sounds')}</span><p class="setting-desc">{tr('typewriter_sounds_desc')}</p></div><label class="toggle"><input type="checkbox" bind:checked={prefs.typewriterSounds} onchange={applyPrefs} /><span class="toggle-slider"></span></label></div>
