"use strict";
(self["webpackChunkMuya"] = self["webpackChunkMuya"] || []).push([["node_modules_mermaid_dist_chunks_mermaid_core_pieDiagram-SKSYHLDU_mjs"],{
...
var DEFAULT_PIE_CONFIG = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.defaultConfig_default.pie;
var DEFAULT_PIE_DB = {
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)((text, id, _version, diagObj) => {
  ...
  const globalConfig = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig2)();
  const pieConfig = (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__.cleanAndMerge)(db2.getConfig(), globalConfig.pie);
  const MARGIN = 40;
  ...
  let [outerStrokeWidth] = (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__.parseFontSize)(themeVariables.pieOuterStrokeWidth);
  outerStrokeWidth ??= 2;
  ...
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.configureSvgSize)(svg, height, totalWidth, pieConfig.useMaxWidth);
}, "draw");
var renderer = { draw };
...
//# sourceMappingURL=node_modules_mermaid_dist_chunks_mermaid_core_pieDiagram-SKSYHLDU_mjs.index.min.js.map