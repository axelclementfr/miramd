(self["webpackChunkMuya"] = self["webpackChunkMuya"] || []).push([["src_lib_muya_lib_parser_render_sequence_js"],{

/***/ "./src/lib/muya/lib/assets/libs/sequence-diagram-snap.js"
/*!***************************************************************!*\
  !*** ./src/lib/muya/lib/assets/libs/sequence-diagram-snap.js ***!
  \***************************************************************/
...
/* harmony import */ var snapsvg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! snapsvg */ "./src/lib/muya/lib/assets/libs/snap.svg-min.js");
...
Diagram.Note.prototype.hasManyActors = function () {
  return underscore__WEBPACK_IMPORTED_MODULE_0__["default"].isArray(this.actor);
};
...
var parser = function () {
 ...
 true && "undefined" != typeof exports && (exports.parser = parser, exports.Parser = parser.Parser, exports.parse = function () {
  ...
  var source = (__webpack_require__(/*! fs */ "?9ce7").readFileSync)((__webpack_require__(/*! path */ "./node_modules/path-browserify/index.js").normalize)(args[1]), "utf8");
...
function ParseError(message, hash) {
  underscore__WEBPACK_IMPORTED_MODULE_0__["default"].extend(this, hash);
...
function wobble(x1, y1, x2, y2) {
  assert(underscore__WEBPACK_IMPORTED_MODULE_0__["default"].all([x1, x2, y1, y2], underscore__WEBPACK_IMPORTED_MODULE_0__["default"].isFinite), 'x1,x2,y1,y2 must be numeric');
...
function handRect(x, y, w, h) {
  assert(underscore__WEBPACK_IMPORTED_MODULE_0__["default"].all([x, y, w, h], underscore__WEBPACK_IMPORTED_MODULE_0__["default"].isFinite), 'x, y, w, h must be numeric');
...
underscore__WEBPACK_IMPORTED_MODULE_0__["default"].extend(BaseTheme.prototype, {
  ...
  layout: function () {
    ...
    underscore__WEBPACK_IMPORTED_MODULE_0__["default"].each(actors, function (a) {
    ...
    underscore__WEBPACK_IMPORTED_MODULE_0__["default"].each(signals, function (s) {
    ...
    underscore__WEBPACK_IMPORTED_MODULE_0__["default"].each(actors, function (a) {
      ...
      underscore__WEBPACK_IMPORTED_MODULE_0__["default"].each(a.distances, function (distance, b) {
  ...
  drawActors: function (offsetY) {
    var y = offsetY;
    underscore__WEBPACK_IMPORTED_MODULE_0__["default"].each(this.diagram.actors, function (a) {
      // Top box
  ...
  drawSignals: function (offsetY) {
    var y = offsetY;
    underscore__WEBPACK_IMPORTED_MODULE_0__["default"].each(this.diagram.signals, function (s) {
...
if (typeof (snapsvg__WEBPACK_IMPORTED_MODULE_1___default()) != 'undefined') {
  ...
  var SnapTheme = function (diagram, options, resume) {
    underscore__WEBPACK_IMPORTED_MODULE_0__["default"].defaults(options, {
      'css-class': 'simple',
      'font-size': 16,
  ...
  underscore__WEBPACK_IMPORTED_MODULE_0__["default"].extend(SnapTheme.prototype, BaseTheme.prototype, {
    ...
    waitForFont: function (callback) {
      ...
      if (typeof (webfontloader__WEBPACK_IMPORTED_MODULE_2___default()) == 'undefined') {
    ...
    setupPaper: function (container) {
      ...
      this.paper_ = snapsvg__WEBPACK_IMPORTED_MODULE_1___default()(svg);
    ...
    createText: function (text, font) {
      text = underscore__WEBPACK_IMPORTED_MODULE_0__["default"].invoke(text.split('\n'), 'trim');
  ...
  underscore__WEBPACK_IMPORTED_MODULE_0__["default"].extend(SnapHandTheme.prototype, SnapTheme.prototype, {
    drawLine: function (x1, y1, x2, y2, linetype, arrowhead) {
...
if (typeof Raphael == 'undefined' && typeof (snapsvg__WEBPACK_IMPORTED_MODULE_1___default()) == 'undefined') {
  throw new Error('Raphael or Snap.svg is required to be included.');
}
if (underscore__WEBPACK_IMPORTED_MODULE_0__["default"].isEmpty(Diagram.themes)) {
...
Diagram.prototype.drawSVG = function (container, options) {
  ...
  options = underscore__WEBPACK_IMPORTED_MODULE_0__["default"].defaults(options || {}, defaultOptions);
  if (!(options.theme in Diagram.themes)) {
    throw new Error('Unsupported theme: ' + options.theme);
  }

  // TODO Write tests for this check
  var div = underscore__WEBPACK_IMPORTED_MODULE_0__["default"].isString(container) ? document.getElementById(container) : container;
...
/***/ "./src/lib/muya/lib/parser/render/sequence.js"
/*!****************************************************!*\
  !*** ./src/lib/muya/lib/parser/render/sequence.js ***!
  \****************************************************/
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _assets_libs_sequence_diagram_snap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../assets/libs/sequence-diagram-snap */ "./src/lib/muya/lib/assets/libs/sequence-diagram-snap.js");
/* harmony import */ var _assets_styles_sequence_diagram_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../assets/styles/sequence-diagram.css */ "./src/lib/muya/lib/assets/styles/sequence-diagram.css");


/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_assets_libs_sequence_diagram_snap__WEBPACK_IMPORTED_MODULE_0__["default"]);

/***/ },

/***/ "./src/lib/muya/lib/assets/libs/snap.svg-min.js"
/*!******************************************************!*\
  !*** ./src/lib/muya/lib/assets/libs/snap.svg-min.js ***!
  \******************************************************/
(module, exports) {

var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_LOCAL_MODULE_0__, __WEBPACK_LOCAL_MODULE_0__exports;var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*** IMPORTS FROM imports-loader ***/
...
/***/ "./src/lib/muya/lib/assets/styles/sequence-diagram.css"
/*!*************************************************************!*\
  !*** ./src/lib/muya/lib/assets/styles/sequence-diagram.css ***!
  \*************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
//# sourceMappingURL=src_lib_muya_lib_parser_render_sequence_js.index.min.js.map