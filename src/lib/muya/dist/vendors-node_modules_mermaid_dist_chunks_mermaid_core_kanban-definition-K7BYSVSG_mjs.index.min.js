"use strict";
(self["webpackChunkMuya"] = self["webpackChunkMuya"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_kanban-definition-K7BYSVSG_mjs"],{
...
/* harmony export */ });
/* harmony import */ var _chunk_HHEYEP7N_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-HHEYEP7N.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-HHEYEP7N.mjs");
...
/* harmony import */ var _chunk_XPW4576I_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-XPW4576I.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-XPW4576I.mjs");
/* harmony import */ var _chunk_KYZI473N_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-KYZI473N.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-KYZI473N.mjs");
/* harmony import */ var _chunk_YBOYWFTD_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chunk-YBOYWFTD.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-YBOYWFTD.mjs");
/* harmony import */ var _chunk_PQ6SQG4A_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chunk-PQ6SQG4A.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-PQ6SQG4A.mjs");
/* harmony import */ var _chunk_PU5JKC2W_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./chunk-PU5JKC2W.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-PU5JKC2W.mjs");
/* harmony import */ var _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./chunk-GEFDOKGD.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-GEFDOKGD.mjs");
/* harmony import */ var _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./chunk-7R4GIKGN.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-7R4GIKGN.mjs");
...
var getData = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_9__.__name)(function() {
  ...
  const conf = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.getConfig2)();
  for (const section of sections2) {
    const node = {
      id: section.id,
      label: (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.sanitizeText)(section.label ?? "", conf),
      labelType: "markdown",
      isGroup: true,
    ...
    for (const item of children) {
      const childNode = {
        id: item.id,
        parentId: section.id,
        label: (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.sanitizeText)(item.label ?? "", conf),
        labelType: "markdown",
        isGroup: false,
        ticket: item?.ticket,
  ...
  return { nodes: _nodes, edges, other: {}, config: (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.getConfig2)() };
}, "getData");
var addNode = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_9__.__name)((level, id, descr, type, shapeData) => {
  const conf = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.getConfig2)();
  let padding = conf.mindmap?.padding ?? _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.defaultConfig_default.mindmap.padding;
  switch (type) {
  ...
  const node = {
    id: (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.sanitizeText)(id, conf) || "kbn" + cnt++,
    level,
    label: (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.sanitizeText)(descr, conf),
    width: conf.mindmap?.maxNodeWidth ?? _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.defaultConfig_default.mindmap.maxNodeWidth,
    padding,
    isGroup: false
  };
  if (shapeData !== void 0) {
...
var decorateNode = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_9__.__name)((decoration) => {
  ...
  const config = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.getConfig2)();
  const node = nodes[nodes.length - 1];
  if (decoration.icon) {
    node.icon = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.sanitizeText)(decoration.icon, config);
  }
  if (decoration.class) {
    node.cssClasses = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.sanitizeText)(decoration.class, config);
  }
}, "decorateNode");
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_9__.__name)(async (text, id, _version, diagObj) => {
  ...
  const svg = (0,_chunk_HHEYEP7N_mjs__WEBPACK_IMPORTED_MODULE_0__.selectSvgElement)(id);
  ...
  for (const section of sections2) {
    ...
    const sectionObj = await (0,_chunk_KYZI473N_mjs__WEBPACK_IMPORTED_MODULE_3__.insertCluster)(sectionsElem, section);
  ...
  for (const section of sections2) {
    ...
    for (const item of sectionItems) {
      ...
      const nodeEl = await (0,_chunk_KYZI473N_mjs__WEBPACK_IMPORTED_MODULE_3__.insertNode)(nodesElem, item, { config: conf });
      const bbox = nodeEl.node().getBBox();
      item.y = y + bbox.height / 2;
      await (0,_chunk_KYZI473N_mjs__WEBPACK_IMPORTED_MODULE_3__.positionNode)(item);
  ...
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.setupGraphViewbox)(
    void 0,
    svg,
    conf.mindmap?.padding ?? _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.defaultConfig_default.kanban.padding,
    conf.mindmap?.useMaxWidth ?? _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_8__.defaultConfig_default.kanban.useMaxWidth
  );
}, "draw");
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_kanban-definition-K7BYSVSG_mjs.index.min.js.map