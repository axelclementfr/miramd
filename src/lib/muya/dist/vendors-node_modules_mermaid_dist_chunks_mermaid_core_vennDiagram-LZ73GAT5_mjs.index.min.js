"use strict";
(self["webpackChunkMuya"] = self["webpackChunkMuya"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_vennDiagram-LZ73GAT5_mjs"],{
...
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! khroma */ "./node_modules/khroma/dist/methods/lighten.js");
...
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! khroma */ "./node_modules/khroma/dist/methods/transparentize.js");
/* harmony import */ var _upsetjs_venn_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @upsetjs/venn.js */ "./node_modules/@upsetjs/venn.js/build/venn.esm.js");
/* harmony import */ var roughjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! roughjs */ "./node_modules/roughjs/bundled/rough.esm.js");
...
var DEFAULT_VENN_CONFIG = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__.defaultConfig_default.venn;
function getConfig2() {
  return (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_1__.cleanAndMerge)(DEFAULT_VENN_CONFIG, (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__.getConfig)().venn);
}
...
var customClear = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(() => {
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__.clear)();
  subsets.length = 0;
  textNodes.length = 0;
...
var db = {
  ...
  setDiagramTitle: _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__.setDiagramTitle,
  getDiagramTitle: _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__.getDiagramTitle,
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((_text, id, _version, diagObj) => {
  ...
  const { themeVariables, look, handDrawnSeed } = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__.getConfig)();
  ...
  const vennDiagram = _upsetjs_venn_js__WEBPACK_IMPORTED_MODULE_9__.VennDiagram().width(svgWidth).height(svgHeight - titleHeight);
  dummyD3root.datum(sets).call(vennDiagram);
  const roughSvg = isHandDrawn ? roughjs__WEBPACK_IMPORTED_MODULE_10__["default"].svg(dummyD3root.select("svg").node()) : void 0;
  const layoutAreas = _upsetjs_venn_js__WEBPACK_IMPORTED_MODULE_9__.layout(sets, {
    width: svgWidth,
  ...
  const themeDark = (0,khroma__WEBPACK_IMPORTED_MODULE_5__["default"])(themeVariables.background || "#f4f4f4");
  dummyD3root.selectAll(".venn-circle").each(function(d, i) {
    ...
    const textColor = customStyle?.color || (themeDark ? (0,khroma__WEBPACK_IMPORTED_MODULE_6__["default"])(baseColor, 30) : (0,khroma__WEBPACK_IMPORTED_MODULE_7__["default"])(baseColor, 30));
  ...
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__.configureSvgSize)(svg, svgHeight, svgWidth, config?.useMaxWidth ?? true);
}, "draw");
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_vennDiagram-LZ73GAT5_mjs.index.min.js.map