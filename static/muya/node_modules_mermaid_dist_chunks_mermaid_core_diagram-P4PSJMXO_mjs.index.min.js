"use strict";
(self["webpackChunkMuya"] = self["webpackChunkMuya"] || []).push([["node_modules_mermaid_dist_chunks_mermaid_core_diagram-P4PSJMXO_mjs"],{
...
var DEFAULT_PACKET_CONFIG = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.defaultConfig_default.packet;
var PacketDB = class {
  constructor() {
    this.packet = [];
    this.setAccTitle = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.setAccTitle;
    this.getAccTitle = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.getAccTitle;
    this.setDiagramTitle = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.setDiagramTitle;
    this.getDiagramTitle = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.getDiagramTitle;
    this.getAccDescription = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.getAccDescription;
    this.setAccDescription = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.setAccDescription;
  }
  static {
  ...
  getConfig() {
    const config = (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__.cleanAndMerge)({
      ...
      ...(0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig)().packet
    });
    if (config.showBits) {
      config.paddingY += 10;
    }
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)((_text, id, _version, diagram2) => {
  ...
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.configureSvgSize)(svg, svgHeight, svgWidth, config.useMaxWidth);
...
var styles = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(({ packet } = {}) => {
  const options = (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__.cleanAndMerge)(defaultPacketStyleOptions, packet);
  return `
	.packetByte {
...
//# sourceMappingURL=node_modules_mermaid_dist_chunks_mermaid_core_diagram-P4PSJMXO_mjs.index.min.js.map