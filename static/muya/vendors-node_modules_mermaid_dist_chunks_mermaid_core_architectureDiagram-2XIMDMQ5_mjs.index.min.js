(self["webpackChunkMuya"] = self["webpackChunkMuya"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_architectureDiagram-2XIMDMQ5_mjs"],{
...
/* harmony import */ var _chunk_PU5JKC2W_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-PU5JKC2W.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-PU5JKC2W.mjs");
...
var DEFAULT_ARCHITECTURE_CONFIG = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.defaultConfig_default.architecture;
var ArchitectureDB = class {
  ...
  getConfig() {
    return (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.cleanAndMerge)({
      ...DEFAULT_ARCHITECTURE_CONFIG,
      ...(0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig)().architecture
    });
  }
...
var architectureIcons = {
  ...
  icons: {
    ...
    unknown: _chunk_PU5JKC2W_mjs__WEBPACK_IMPORTED_MODULE_1__.unknownIcon,
    blank: {
      body: wrapIcon("")
    }
  }
  ...
  await Promise.all(
    cy.edges().map(async (edge) => {
      ...
      if (edge[0]._private.rscratch) {
        ...
        g.insert("path").attr("d", `M ${startX},${startY} L ${midX},${midY} L${endX},${endY} `).attr("class", "edge").attr("id", (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.getEdgeId)(source, target, { prefix: "L" }));
        if (sourceArrow) {
        ...
        if (label) {
          ...
          await (0,_chunk_PU5JKC2W_mjs__WEBPACK_IMPORTED_MODULE_1__.createText)(
            textElem,
            label,
            {
              useHtmlLabels: false,
            ...
            (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)()
          );
    ...
    cy.nodes().map(async (node) => {
      ...
      if (data.type === "group") {
        ...
        if (data.icon) {
          ...
          bkgElem.html(
            `<g>${await (0,_chunk_PU5JKC2W_mjs__WEBPACK_IMPORTED_MODULE_1__.getIconSVG)(data.icon, { height: groupIconSize, width: groupIconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
          );
          bkgElem.attr(
            "transform",
...
var drawServices = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(async function(db, elem, services) {
  ...
  for (const service of services) {
    ...
    if (service.icon) {
      bkgElem.html(
        `<g>${await (0,_chunk_PU5JKC2W_mjs__WEBPACK_IMPORTED_MODULE_1__.getIconSVG)(service.icon, { height: iconSize, width: iconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
      );
    } else if (service.iconText) {
      bkgElem.html(
        `<g>${await (0,_chunk_PU5JKC2W_mjs__WEBPACK_IMPORTED_MODULE_1__.getIconSVG)("blank", { height: iconSize, width: iconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
      );
      const textElemContainer = bkgElem.append("g");
      const fo = textElemContainer.append("foreignObject").attr("width", iconSize).attr("height", iconSize);
      const divElem = fo.append("div").attr("class", "node-icon-text").attr("style", `height: ${iconSize}px;`).append("div").html((0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.sanitizeText)(service.iconText, config));
...
// src/diagrams/architecture/architectureRenderer.ts
(0,_chunk_PU5JKC2W_mjs__WEBPACK_IMPORTED_MODULE_1__.registerIconPacks)([
  {
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(async (text, id, _version, diagObj) => {
  ...
  positionNodes(db, cy);
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.setupGraphViewbox)(void 0, svg, db.getConfigField("padding"), db.getConfigField("useMaxWidth"));
}, "draw");
var renderer = { draw };
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_architectureDiagram-2XIMDMQ5_mjs.index.min.js.map