"use strict";
(self["webpackChunkMuya"] = self["webpackChunkMuya"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_blockDiagram-WCTKOSBZ_mjs"],{
...
/* harmony import */ var _chunk_MX3YWQON_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-MX3YWQON.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-MX3YWQON.mjs");
/* harmony import */ var _chunk_YBOYWFTD_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-YBOYWFTD.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-YBOYWFTD.mjs");
/* harmony import */ var _chunk_PU5JKC2W_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-PU5JKC2W.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-PU5JKC2W.mjs");
/* harmony import */ var _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chunk-GEFDOKGD.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-GEFDOKGD.mjs");
/* harmony import */ var _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chunk-7R4GIKGN.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-7R4GIKGN.mjs");
...
var BG_FILL = "bgFill";
var STYLECLASS_SEP = ",";
var config = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)();
var classes = /* @__PURE__ */ new Map();
var sanitizeText2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)((txt) => _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeText(txt, config), "sanitizeText");
...
var clear2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(() => {
  ...
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.clear)();
...
var db = {
  getConfig: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(() => (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig)().block, "getConfig"),
  typeStr2Type,
  edgeTypeStr2Type,
  edgeStrToEdgeData,
  getLogger,
...
var padding = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)()?.block?.padding ?? 8;
...
var createLabel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(async (element, _vertexText, style, isTitle = false, isNode = false) => {
  ...
  const config2 = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)();
  const useHtmlLabels = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getEffectiveHtmlLabels)(config2);
  return await (0,_chunk_PU5JKC2W_mjs__WEBPACK_IMPORTED_MODULE_3__.createText)(
    element,
    vertexText,
    {
      style,
...
var insertEdgeLabel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(async (elem, edge) => {
  ...
  const labelElement = await (0,_chunk_PU5JKC2W_mjs__WEBPACK_IMPORTED_MODULE_3__.createText)(
    elem,
    edge.label,
    {
  ...
  label.attr("transform", (0,_chunk_MX3YWQON_mjs__WEBPACK_IMPORTED_MODULE_1__.computeLabelTransform)(transformBbox, useHtmlLabels));
  ...
  if (edge.startLabelLeft) {
    ...
    inner.attr("transform", (0,_chunk_MX3YWQON_mjs__WEBPACK_IMPORTED_MODULE_1__.computeLabelTransform)(slBox, useHtmlLabels));
...
function setTerminalWidth(fo, value) {
  if ((0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getEffectiveHtmlLabels)((0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)()) && fo) {
...
var positionEdgeLabel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)((edge, paths) => {
  ...
  const siteConfig = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)();
  const { subGraphTitleTotalMargin } = (0,_chunk_YBOYWFTD_mjs__WEBPACK_IMPORTED_MODULE_2__.getSubGraphTitleMargins)(siteConfig);
  if (edge.label) {
    const el = edgeLabels[edge.id];
    let x = edge.x;
    let y = edge.y;
    if (path) {
      const pos = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_4__.utils_default.calcLabelPosition(path);
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.debug(
  ...
  if (edge.startLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_4__.utils_default.calcTerminalLabelPosition(edge.arrowTypeStart ? 10 : 0, "start_left", path);
      x = pos.x;
      y = pos.y;
    }
  ...
  if (edge.startLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_4__.utils_default.calcTerminalLabelPosition(
  ...
  if (edge.endLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_4__.utils_default.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_left", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", `translate(${x}, ${y})`);
  ...
  if (edge.endLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_4__.utils_default.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_right", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", `translate(${x}, ${y})`);
...
var insertEdge = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(function(elem, e, edge, clusterDb, diagramType, graph, id) {
  ...
  const { x, y } = (0,_chunk_MX3YWQON_mjs__WEBPACK_IMPORTED_MODULE_1__.getLineFunctionsWithOffset)(edge);
  ...
  let url = "";
  if ((0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)().flowchart.arrowMarkerAbsolute || (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)().state.arrowMarkerAbsolute) {
    url = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getUrl)(true);
  }
...
var labelHelper = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(async (parent, node, _classes, isNode) => {
  const config2 = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)();
  let classes2;
  const useHtmlLabels = node.useHtmlLabels || (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getEffectiveHtmlLabels)(config2);
  if (!_classes) {
  ...
  if (node.labelType === "markdown") {
    text = (0,_chunk_PU5JKC2W_mjs__WEBPACK_IMPORTED_MODULE_3__.createText)(
      label,
      (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.sanitizeText)((0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_4__.decodeEntities)(labelText), config2),
      {
        useHtmlLabels,
  ...
  if ((0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getEffectiveHtmlLabels)(config2)) {
    const div = text.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_10__.select)(text);
    await (0,_chunk_YBOYWFTD_mjs__WEBPACK_IMPORTED_MODULE_2__.configureLabelImages)(div, labelText);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
    dv.attr("height", bbox.height);
  }
...
var note = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(async (parent, node) => {
  const useHtmlLabels = node.useHtmlLabels || (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getEffectiveHtmlLabels)((0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)());
  if (!useHtmlLabels) {
...
var rectWithTitle = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(async (parent, node) => {
  ...
  if ((0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getEffectiveHtmlLabels)((0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)())) {
    const div = text.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_10__.select)(text);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
...
var insertNode = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(async (elem, node, renderOptions) => {
  ...
  if (node.link) {
    let target;
    if ((0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)().securityLevel === "sandbox") {
      target = "_top";
...
function getNodeFromBlock(block, db2, positioned = false) {
  ...
  const styles = (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_4__.getStylesFromArray)(vertex?.styles ?? []);
  ...
  const node = {
    ...
    intersect: void 0,
    type: vertex.type,
    padding: padding2 ?? (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig)()?.block?.padding ?? 0
  };
  return node;
}
...
async function calculateBlockSize(elem, block, db2) {
  ...
  const config2 = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig)();
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(async function(text, id, _version, diagObj) {
  const { securityLevel, block: conf } = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig)();
  ...
  if (bounds) {
    ...
    (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__.configureSvgSize)(svg, height, width, !!useMaxWidth);
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_blockDiagram-WCTKOSBZ_mjs.index.min.js.map