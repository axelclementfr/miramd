"use strict";
(self["webpackChunkMuya"] = self["webpackChunkMuya"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_gitGraphDiagram-K3NZZRJ6_mjs"],{
...
/* harmony import */ var _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-GEFDOKGD.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-GEFDOKGD.mjs");
/* harmony import */ var _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-7R4GIKGN.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-7R4GIKGN.mjs");
...
var DEFAULT_GITGRAPH_CONFIG = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.defaultConfig_default.gitGraph;
var getConfig2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(() => {
  const config = (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__.cleanAndMerge)({
    ...DEFAULT_GITGRAPH_CONFIG,
    ...(0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig)().gitGraph
  });
  return config;
}, "getConfig");
...
function getID() {
  return (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__.random)({ length: 7 });
}
...
var commit = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(function(commitDB) {
  ...
  const config = getConfig2();
  id = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(id, config);
  msg = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(msg, config);
  tags = tags?.map((tag) => _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(tag, config));
  const newCommit = {
...
var branch = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(function(branchDB) {
  ...
  name = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(name, getConfig2());
...
var merge = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)((mergeDB) => {
  ...
  const config = getConfig2();
  otherBranch = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(otherBranch, config);
  if (customId) {
    customId = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(customId, config);
  }
...
var cherryPick = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(function(cherryPickDB) {
  ...
  const config = getConfig2();
  sourceId = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(sourceId, config);
  targetId = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(targetId, config);
  tags = tags?.map((tag) => _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(tag, config));
  parentCommitId = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(parentCommitId, config);
...
var checkout = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(function(branch2) {
  branch2 = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(branch2, getConfig2());
...
var clear2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(function() {
  state.reset();
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.clear)();
}, "clear");
...
var db = {
  ...
  getDirection,
  getHead,
  setAccTitle: _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.setAccTitle,
  getAccTitle: _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.getAccTitle,
  getAccDescription: _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.getAccDescription,
  setAccDescription: _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.setAccDescription,
  setDiagramTitle: _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.setDiagramTitle,
  getDiagramTitle: _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.getDiagramTitle
};
...
var drawCommitLabel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)((gLabels, commit2, commitPosition, pos, gitGraphConfig) => {
...
var drawCommits = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)((svg, commits, modifyGraph, gitGraphConfig) => {
...
var drawBranches = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)((svg, branches, gitGraphConfig) => {
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(function(txt, id, ver, diagObj) {
  ...
  if (!db2.getConfig) {
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.log.error("getConfig method is not available on db");
    return;
  }
  ...
  _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__.utils_default.insertTitle(
    diagram2,
    "gitTitleText",
    gitGraphConfig.titleTopMargin ?? 0,
    db2.getDiagramTitle()
  );
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.setupGraphViewbox2)(void 0, diagram2, gitGraphConfig.diagramPadding, gitGraphConfig.useMaxWidth);
}, "draw");
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_gitGraphDiagram-K3NZZRJ6_mjs.index.min.js.map