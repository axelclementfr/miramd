"use strict";
(self["webpackChunkMuya"] = self["webpackChunkMuya"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_mindmap-definition-YRQLILUH_mjs"],{
...
var MindmapDB = class {
  ...
  addNode(level, id, descr, type) {
    ...
    const conf = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_10__.getConfig2)();
    let padding = conf.mindmap?.padding ?? _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_10__.defaultConfig_default.mindmap.padding;
    switch (type) {
    ...
    const node = {
      id: this.count++,
      nodeId: (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_10__.sanitizeText)(id, conf),
      level,
      descr: (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_10__.sanitizeText)(descr, conf),
      type,
      children: [],
      width: conf.mindmap?.maxNodeWidth ?? _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_10__.defaultConfig_default.mindmap.maxNodeWidth,
      padding,
      isRoot
    };
  ...
  decorateNode(decoration) {
    ...
    if (decoration.icon) {
      node.icon = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_10__.sanitizeText)(decoration.icon, config);
    }
    if (decoration.class) {
      node.class = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_10__.sanitizeText)(decoration.class, config);
    }
  }
  type2Str(type) {
    switch (type) {
  ...
  getData() {
    ...
    const config = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_10__.getConfig2)();
    const userDefinedConfig = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_10__.getUserDefinedConfig)();
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(async (text, id, _version, diagObj) => {
  ...
  data4Layout.layoutAlgorithm = (0,_chunk_GLR3WWYH_mjs__WEBPACK_IMPORTED_MODULE_2__.getRegisteredLayoutAlgorithm)(data4Layout.config.layout, {
  ...
  (0,_chunk_KX2RTZJC_mjs__WEBPACK_IMPORTED_MODULE_1__.setupViewPortForSVG)(
    svg,
    data4Layout.config.mindmap?.padding ?? _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_10__.defaultConfig_default.mindmap.padding,
    "mindmapDiagram",
    data4Layout.config.mindmap?.useMaxWidth ?? _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_10__.defaultConfig_default.mindmap.useMaxWidth
  );
}, "draw");
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_mindmap-definition-YRQLILUH_mjs.index.min.js.map