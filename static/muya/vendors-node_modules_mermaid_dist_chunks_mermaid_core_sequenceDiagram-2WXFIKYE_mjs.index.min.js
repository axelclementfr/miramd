"use strict";
(self["webpackChunkMuya"] = self["webpackChunkMuya"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_sequenceDiagram-2WXFIKYE_mjs"],{
...
/* harmony export */ });
/* harmony import */ var _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-7R4GIKGN.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-7R4GIKGN.mjs");
...
var drawText = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)((element, textData) => {
  const nText = textData.text.replace(_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_0__.lineBreakRegex, " ");
...
/* harmony export */ });
/* harmony import */ var _chunk_XPW4576I_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-XPW4576I.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-XPW4576I.mjs");
/* harmony import */ var _chunk_JSJVCQXG_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-JSJVCQXG.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-JSJVCQXG.mjs");
...
/* harmony import */ var _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-GEFDOKGD.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-GEFDOKGD.mjs");
/* harmony import */ var _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chunk-7R4GIKGN.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-7R4GIKGN.mjs");
...
var SequenceDB = class {
  constructor() {
    ...
    this.setAccTitle = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.setAccTitle;
    this.setAccDescription = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.setAccDescription;
    this.setDiagramTitle = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.setDiagramTitle;
    this.getAccTitle = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getAccTitle;
    this.getAccDescription = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getAccDescription;
    this.getDiagramTitle = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getDiagramTitle;
    this.apply = this.apply.bind(this);
    this.parseBoxData = this.parseBoxData.bind(this);
    this.parseMessage = this.parseMessage.bind(this);
    this.clear();
    this.setWrap((0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)().wrap);
  ...
  addActor(id, name, description, type, metadata) {
    ...
    if (metadata !== void 0) {
      ...
      doc = (0,_chunk_XPW4576I_mjs__WEBPACK_IMPORTED_MODULE_0__.load)(yamlData, { schema: _chunk_XPW4576I_mjs__WEBPACK_IMPORTED_MODULE_0__.JSON_SCHEMA });
    }
    type = doc?.type ?? type;
  ...
  autoWrap() {
    ...
    return (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)().sequence?.wrap ?? false;
  }
  clear() {
    this.state.reset();
    (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.clear)();
  }
  parseMessage(str) {
  ...
  parseBoxData(str) {
    ...
    return {
      text: cleanedText ? (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.sanitizeText)(cleanedText, (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)()) : void 0,
      color,
      wrap
    };
  }
  ...
  addLinks(actorId, text) {
    ...
    try {
      let sanitizedText = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.sanitizeText)(text.text, (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)());
  ...
  addProperties(actorId, text) {
    const actor = this.getActor(actorId);
    try {
      const sanitizedText = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.sanitizeText)(text.text, (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)());
    ...
    if (Array.isArray(param)) {
      ...
      switch (param.type) {
        ...
        case "altEnd":
          ...
          break;
        case "setAccTitle":
          (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.setAccTitle)(param.text);
          break;
        case "parStart":
  ...
  getConfig() {
    return (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)().sequence;
  }
};
...
var drawRect2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(elem, rectData) {
  return (0,_chunk_JSJVCQXG_mjs__WEBPACK_IMPORTED_MODULE_1__.drawRect)(elem, rectData);
}, "drawRect");
...
var drawKatex = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(async function(elem, textData, msgModel = null) {
  ...
  const linesSanitized = await (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.renderKatexSanitized)(textData.text, (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig)());
...
var drawText = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(elem, textData) {
  ...
  let textHeight = 0;
  const lines = textData.text.split(_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.lineBreakRegex);
  const [_textFontSize, _textFontSizePx] = (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.parseFontSize)(textData.fontSize);
  let textElems = [];
  let dy = 0;
  ...
  for (let [i, line] of lines.entries()) {
    ...
    const text = line || _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.ZERO_WIDTH_SPACE;
    if (textData.tspan) {
...
var drawActorTypeParticipant = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(elem, actor, conf2, isFooter) {
  ...
  const rect = (0,_chunk_JSJVCQXG_mjs__WEBPACK_IMPORTED_MODULE_1__.getNoteRect)();
  var cssclass = "actor";
  ...
  if (actor.properties?.icon) {
    ...
    if (iconSrc.charAt(0) === "@") {
      (0,_chunk_JSJVCQXG_mjs__WEBPACK_IMPORTED_MODULE_1__.drawEmbeddedImage)(g, rect.x + rect.width - 20, rect.y + 10, iconSrc.substr(1));
    } else {
      (0,_chunk_JSJVCQXG_mjs__WEBPACK_IMPORTED_MODULE_1__.drawImage)(g, rect.x + rect.width - 20, rect.y + 10, iconSrc);
    }
  }
  _drawTextCandidateFunc(conf2, (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.hasKatex)(actor.description))(
    actor.description,
    g,
    rect.x,
    rect.y,
...
var drawActorTypeQueue = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(elem, actor, conf2, isFooter) {
  ...
  if (actor.properties?.icon) {
    ...
    if (iconSrc.charAt(0) === "@") {
      (0,_chunk_JSJVCQXG_mjs__WEBPACK_IMPORTED_MODULE_1__.drawEmbeddedImage)(g, iconX, iconY, iconSrc.substr(1));
    } else {
      (0,_chunk_JSJVCQXG_mjs__WEBPACK_IMPORTED_MODULE_1__.drawImage)(g, iconX, iconY, iconSrc);
    }
  }
  _drawTextCandidateFunc(conf2, (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.hasKatex)(actor.description))(
    actor.description,
...
var drawLoop = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(async function(elem, loopModel, labelText, conf2) {
  ...
  let txt = (0,_chunk_JSJVCQXG_mjs__WEBPACK_IMPORTED_MODULE_1__.getTextObj)();
  txt.text = labelText;
  ...
  txt.fontWeight = fontWeight;
  txt.wrap = true;
  let textElem = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.hasKatex)(txt.text) ? await drawKatex(g, txt, loopModel) : drawText(g, txt);
  if (loopModel.sectionTitles !== void 0) {
    for (const [idx, item] of Object.entries(loopModel.sectionTitles)) {
      if (item.message) {
        ...
        if ((0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.hasKatex)(txt.text)) {
...
var drawBackgroundRect2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(elem, bounds2) {
  (0,_chunk_JSJVCQXG_mjs__WEBPACK_IMPORTED_MODULE_1__.drawBackgroundRect)(elem, bounds2);
}, "drawBackgroundRect");
...
var _drawTextCandidateFunc = /* @__PURE__ */ (function() {
  ...
  function byTspan(content, g, x, y, width, height, textAttrs, conf2) {
    ...
    const [_actorFontSize, _actorFontSizePx] = (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.parseFontSize)(actorFontSize);
    const lines = content.split(_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.lineBreakRegex);
  ...
  async function byKatex(content, g, x, y, width, height, textAttrs, conf2) {
    const dim = await (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.calculateMathMLDimensions)(content, (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig)());
    const s = g.append("switch");
    ...
    text.append("div").style("text-align", "center").style("vertical-align", "middle").html(await (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.renderKatexSanitized)(content, (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig)()));
    byTspan(content, s, x, y, width, height, textAttrs, conf2);
    _setTextAttrs(text, textAttrs);
  }
...
var insertSolidTopArrowHead = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(elem) {
...
var insertSolidBottomArrowHead = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(elem) {
...
var insertStickTopArrowHead = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(elem) {
...
var insertStickBottomArrowHead = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(elem) {
...
var bounds = {
  ...
  init: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function() {
    ...
    this.verticalPos = 0;
    setConf((0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)());
  }, "init"),
  ...
  insert: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(startx, starty, stopx, stopy) {
    const _startx = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMin(startx, stopx);
    const _stopx = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(startx, stopx);
    const _starty = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMin(starty, stopy);
    const _stopy = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(starty, stopy);
  ...
  bumpVerticalPos: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(bump) {
    ...
    this.data.stopy = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(this.data.stopy, this.verticalPos);
  }, "bumpVerticalPos"),
...
var drawNote = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(async function(elem, noteModel) {
  ...
  const textObj = (0,_chunk_JSJVCQXG_mjs__WEBPACK_IMPORTED_MODULE_1__.getTextObj)();
  ...
  const textElem = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.hasKatex)(textObj.text) ? await drawKatex(g, textObj) : drawText(g, textObj);
...
var drawCentralConnection = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(elem, msg, msgModel, diagObj, startx, stopx, lineStartY) {
  ...
  const getCircleOffset = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)((isLeftToRight2, isReverse2) => {
  ...
  const drawCircle = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)((cx) => {
...
async function boundMessage(_diagram, msgModel) {
  ...
  const lines = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.splitBreaks(message).length;
  const isKatexMsg = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.hasKatex)(message);
  const textDims = isKatexMsg ? await (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.calculateMathMLDimensions)(message, (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)()) : _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.calculateTextDimensions(message, messageFont(conf));
  if (!isKatexMsg) {
  ...
  if (startx === stopx) {
    ...
    totalOffset += 30;
    const dx = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(textWidth / 2, conf.width / 2);
    bounds.insert(
      startx - dx,
...
var drawMessage = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(async function(diagram2, msgModel, lineStartY, diagObj, msg) {
  const { startx, stopx, starty, message, type, sequenceIndex, sequenceVisible } = msgModel;
  const textDims = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.calculateTextDimensions(message, messageFont(conf));
  const textObj = (0,_chunk_JSJVCQXG_mjs__WEBPACK_IMPORTED_MODULE_1__.getTextObj)();
  textObj.x = startx;
  textObj.y = starty + 10;
  ...
  textObj.tspan = false;
  if ((0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.hasKatex)(textObj.text)) {
  ...
  if (startx === stopx) {
    ...
    if (conf.rightAngles) {
      line = diagram2.append("path").attr(
        "d",
        `M  ${lineStartX},${lineStartY} H ${startx + _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(conf.width / 2, textWidth / 2)} V ${lineStartY + 25} H ${startx}`
      );
    } else {
      line = diagram2.append("path").attr(
        "d",
  ...
  if (conf.arrowMarkerAbsolute) {
    url = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getUrl)(true);
  }
...
var addActorRenderingData = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(diagram2, actors, createdActors, actorKeys, verticalPos, messages, isFooter) {
  ...
  for (const actorKey of actorKeys) {
    ...
    actor.height = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(actor.height || conf.height, conf.height);
    actor.margin = actor.margin || conf.actorMargin;
    maxHeight = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(maxHeight, actor.height);
...
var drawActors = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(async function(diagram2, actors, actorKeys, isFooter) {
  if (!isFooter) {
    ...
    for (const actorKey of actorKeys) {
      ...
      maxHeight = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(maxHeight, height);
    }
...
var setConf = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(cnf) {
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.assignWithDepth_default)(conf, cnf);
  if (cnf.fontFamily) {
...
var activationBounds = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(actor, actors) {
  ...
  const left = activations.reduce(
    function(acc, activation) {
      return _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMin(acc, activation.startx);
    },
    actorObj.x + actorObj.width / 2 - 1
  );
  const right = activations.reduce(
    function(acc, activation) {
      return _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(acc, activation.stopx);
    },
    actorObj.x + actorObj.width / 2 + 1
  );
  return [left, right];
...
function adjustLoopHeightForWrap(loopWidths, msg, preMargin, postMargin, addLoopFn) {
  ...
  if (msg.id && msg.message && loopWidths[msg.id]) {
    ...
    msg.message = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.wrapLabel(`[${msg.message}]`, loopWidth - 2 * conf.wrapPadding, textConf);
    msg.width = loopWidth;
    msg.wrap = true;
    const textDims = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.calculateTextDimensions(msg.message, textConf);
    const totalOffset = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(textDims.height, conf.labelBoxHeight);
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(async function(_text, id, _version, diagObj) {
  const { securityLevel, sequence } = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)();
  conf = sequence;
  let sandboxElement;
  ...
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.configureSvgSize)(diagram2, height, width, conf.useMaxWidth);
...
async function getMaxMessageWidthPerActor(actors, messages, diagObj) {
  ...
  for (const msg of messages) {
    if (actors.get(msg.to) && actors.get(msg.from)) {
      ...
      const wrappedMessage = msg.wrap ? _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.wrapLabel(msg.message, conf.width - 2 * conf.wrapPadding, textFont) : msg.message;
      const messageDimensions = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.hasKatex)(wrappedMessage) ? await (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.calculateMathMLDimensions)(msg.message, (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)()) : _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.calculateTextDimensions(wrappedMessage, textFont);
      const messageWidth = messageDimensions.width + 2 * conf.wrapPadding;
      if (isMessage && msg.from === actor.nextActor) {
        maxMessageWidthPerActor[msg.to] = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(
          maxMessageWidthPerActor[msg.to] || 0,
          messageWidth
        );
      } else if (isMessage && msg.from === actor.prevActor) {
        maxMessageWidthPerActor[msg.from] = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(
        ...
        maxMessageWidthPerActor[actor.prevActor] = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(
...
var getRequiredPopupWidth = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(actor) {
  ...
  for (const key in actor.links) {
    const labelDimensions = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.calculateTextDimensions(key, textFont);
...
async function calculateActorMargins(actors, actorToMessageWidth, boxes) {
  ...
  for (const prop of actors.keys()) {
    ...
    if (actor.wrap) {
      actor.description = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.wrapLabel(
        actor.description,
        conf.width - 2 * conf.wrapPadding,
        actorFont(conf)
      );
    }
    const actDims = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.hasKatex)(actor.description) ? await (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.calculateMathMLDimensions)(actor.description, (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)()) : _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.calculateTextDimensions(actor.description, actorFont(conf));
    actor.width = actor.wrap ? conf.width : _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(conf.width, actDims.width + 2 * conf.wrapPadding);
    actor.height = actor.wrap ? _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(actDims.height, conf.height) : conf.height;
    maxHeight = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(maxHeight, actor.height);
  }
  for (const actorKey in actorToMessageWidth) {
    ...
    if (!nextActor) {
      ...
      actor.margin = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(actorWidth2, conf.actorMargin);
      continue;
    }
    const messageWidth = actorToMessageWidth[actorKey];
    const actorWidth = messageWidth + conf.actorMargin - actor.width / 2 - nextActor.width / 2;
    actor.margin = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(actorWidth, conf.actorMargin);
  }
  let maxBoxHeight = 0;
  boxes.forEach((box) => {
    ...
    if (box.wrap) {
      box.name = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.wrapLabel(box.name, totalWidth - 2 * conf.wrapPadding, textFont);
    }
    const boxMsgDimensions = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.calculateTextDimensions(box.name, textFont);
    maxBoxHeight = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(boxMsgDimensions.height, maxBoxHeight);
    const minWidth = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(totalWidth, boxMsgDimensions.width + 2 * conf.wrapPadding);
  ...
  return _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(maxHeight, conf.height);
}
...
var buildNoteModel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(async function(msg, actors, diagObj) {
  ...
  let textDimensions = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.hasKatex)(msg.message) ? await (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.calculateMathMLDimensions)(msg.message, (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)()) : _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.calculateTextDimensions(
    shouldWrap ? _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.wrapLabel(msg.message, conf.width, noteFont(conf)) : msg.message,
    noteFont(conf)
  );
  const noteModel = {
    width: shouldWrap ? conf.width : _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin),
    height: 0,
    startx: fromActor.x,
    stopx: 0,
    starty: 0,
  ...
  if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) {
    noteModel.width = shouldWrap ? _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(conf.width, textDimensions.width) : _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(
      fromActor.width / 2 + toActor.width / 2,
      textDimensions.width + 2 * conf.noteMargin
    );
    noteModel.startx = startx + (fromActor.width + conf.actorMargin) / 2;
  } else if (msg.placement === diagObj.db.PLACEMENT.LEFTOF) {
    noteModel.width = shouldWrap ? _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin) : _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(
      fromActor.width / 2 + toActor.width / 2,
      textDimensions.width + 2 * conf.noteMargin
    );
    noteModel.startx = startx - noteModel.width + (fromActor.width - conf.actorMargin) / 2;
  } else if (msg.to === msg.from) {
    textDimensions = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.calculateTextDimensions(
      shouldWrap ? _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.wrapLabel(msg.message, _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(conf.width, fromActor.width), noteFont(conf)) : msg.message,
      noteFont(conf)
    );
    noteModel.width = shouldWrap ? _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(conf.width, fromActor.width) : _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(fromActor.width, conf.width, textDimensions.width + 2 * conf.noteMargin);
  ...
  if (shouldWrap) {
    noteModel.message = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.wrapLabel(
      msg.message,
...
var hasCentralConnection = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(msg, diagObj) {
  const { CENTRAL_CONNECTION, CENTRAL_CONNECTION_REVERSE, CENTRAL_CONNECTION_DUAL } = diagObj.db.LINETYPE;
...
var calculateCentralConnectionOffset = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(msg, diagObj, isArrowToRight) {
  const {
...
var isReverseArrowType = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(msg, diagObj) {
  const {
...
var isBidirectionalArrowType = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(msg, diagObj) {
...
var buildMessageModel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(msg, actors, diagObj) {
  ...
  if (msg.wrap && msg.message) {
    msg.message = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.wrapLabel(
      msg.message,
      _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(boundedWidth + 2 * conf.wrapPadding, conf.width),
      messageFont(conf)
    );
  }
  const msgDims = _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.calculateTextDimensions(msg.message, messageFont(conf));
  return {
    width: _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(
...
var calculateLoopBounds = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(async function(messages, actors, _maxWidthPerActor, diagObj) {
  ...
  for (const msg of messages) {
    ...
    if (isNote) {
      ...
      stack.forEach((stk) => {
        current = stk;
        current.from = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMin(current.from, noteModel.startx);
        current.to = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(current.to, noteModel.startx + noteModel.width);
        current.width = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(current.width, Math.abs(current.from - current.to)) - conf.labelBoxWidth;
      });
    } else {
      ...
      if (msgModel.startx && msgModel.stopx && stack.length > 0) {
        stack.forEach((stk) => {
          ...
          if (msgModel.startx === msgModel.stopx) {
            ...
            current.from = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMin(
              from.x - msgModel.width / 2,
              from.x - from.width / 2,
              current.from
            );
            current.to = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(
              to.x + msgModel.width / 2,
              to.x + from.width / 2,
              current.to
            );
            current.width = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(current.width, Math.abs(current.to - current.from)) - conf.labelBoxWidth;
          } else {
            current.from = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMin(msgModel.startx, current.from);
            current.to = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(msgModel.stopx, current.to);
            current.width = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.getMax(current.width, msgModel.width) - conf.labelBoxWidth;
          }
        });
      }
    }
...
var diagram = {
  ...
  init: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)((cnf) => {
    ...
    if (cnf.wrap) {
      ...
      (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_4__.setConfig2)({ sequence: { wrap: cnf.wrap } });
    }
  }, "init")
};
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_sequenceDiagram-2WXFIKYE_mjs.index.min.js.map