"use strict";
(self["webpackChunkMuya"] = self["webpackChunkMuya"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_xychartDiagram-JWTSCODW_mjs"],{
...
var TextDimensionCalculatorWithFont = class {
  ...
  getMaxDimension(texts, fontSize) {
    ...
    for (const t of texts) {
      const bbox = (0,_chunk_PU5JKC2W_mjs__WEBPACK_IMPORTED_MODULE_1__.computeDimensionOfText)(elem, 1, t);
...
function getChartDefaultThemeConfig() {
  const defaultThemeVariables = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.getThemeVariables)();
  const config = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig)();
  return (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__.cleanAndMerge)(defaultThemeVariables.xyChart, config.themeVariables.xyChart);
}
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(getChartDefaultThemeConfig, "getChartDefaultThemeConfig");
function getChartDefaultConfig() {
  const config = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig)();
  return (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__.cleanAndMerge)(
    _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.defaultConfig_default.xyChart,
    config.xyChart
  );
}
...
function textSanitizer(text) {
  const config = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig)();
  return (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.sanitizeText)(text.trim(), config);
}
...
function getDrawableElem() {
  ...
  xyChartData.title = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.getDiagramTitle)();
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)((txt, id, _version, diagObj) => {
  ...
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__.configureSvgSize)(svg, chartConfig.height, chartConfig.width, true);
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_xychartDiagram-JWTSCODW_mjs.index.min.js.map